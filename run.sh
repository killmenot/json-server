...
export ydb_routines="/app/node_modules/nodem/src /root/.yottadb/${ydb_path}/o*(/root/.yottadb/${ydb_path}/r /root/.yottadb/r) /usr/local/lib/yottadb/${ydb_version}/libyottadbutil.so"
export gtmroutines="/app/node_modules/nodem/src /root/.yottadb/${ydb_path}/o*(/root/.yottadb/${ydb_path}/r /root/.yottadb/r) /usr/local/lib/yottadb/${ydb_version}/libyottadbutil.so"
export GTMCI="/app/node_modules/nodem/resources/nodem.ci"
export ydb_ci="/app/node_modules/nodem/resources/nodem.ci"
